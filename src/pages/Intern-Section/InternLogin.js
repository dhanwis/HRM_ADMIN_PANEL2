...
import signinbg from "../../assets/images/gif2.gif";
...
export default class StaffLogin extends Component {
  render() {
    const onFinish = async (values) => {
      ...
      try {
        let response = await axios.post(`${baseUrl}/intern-login/`, values);

        if (response.status === 200) {
          enqueueSnackbar("Intern Login success", {
            variant: "success",
          });
