...
//           <Link to="/intern/login" className="btn-sign-in"> 
//             {profile}
//             <span>Log out</span>
...
function InternHeader({
  ...
  const handleNotificationClick = (title) => {
    if (title === "Leave request") {
      ...
      // return <Link to="/admin/tables" />
      // <Link to="/admin/tables"></Link>
      history.push("/leave/dashboard");

      



    } else if (title === "New message from Sophie") {
      showModal("Someone wants to change password", [
        <Button
          key="accept"
    ...
    <div style={{marginTop:'20px',marginBottom:'10px'}}>
      ...
      <Row gutter={[24, 0]}>
        ...
        <Col span={24} md={18} className="header-control">
          ...
          <Link to="/intern/login" className="btn-sign-in" style={{textDecoration:"none"}}>
