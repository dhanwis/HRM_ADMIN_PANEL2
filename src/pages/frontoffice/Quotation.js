...
const Quotation = () => {
  ...
  return (
    <div style={{backgroundImage:`url(${ bg })`,height:"1500px"}}>
    <Container style={{ paddingTop: "50px" }}>
      ...
      {viewingQuotation && (
        <div style={{ marginTop: "20px" }}>
          ...
          <p><strong>Company Name:</strong> {viewingQuotation.companyName}</p>
          <p><strong>Customer Name:</strong> {viewingQuotation.customerName}</p>
          <p><strong>Quotation Type:</strong> {viewingQuotation.quotationType}</p>
          <p><strong>Addon:</strong> {new Date(viewingQuotation.addon).toDateString()}</p>
          <p><strong>Expired On:</strong> {new Date(viewingQuotation.expiredOn).toDateString()}</p>
          <p><strong>Introduction:</strong> {viewingQuotation.introduction}</p>
          <h3>Strategy</h3>
          <ul>
