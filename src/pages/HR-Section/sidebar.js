    ...
    <div style={{width:'50%'}}>
      ...
      <Menu.Item key="1">
          <NavLink to="/admin/profile" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Profile</span>
          </NavLink>
        </Menu.Item>
        ...
        <Menu.Item key="2">
          <NavLink to="/admin/dashboard" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Dashboard</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="3">
          <NavLink to="/admin/register" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Employees</span>
          </NavLink>
        </Menu.Item> 
        ...
        <Menu.Item key="4">
          <NavLink to="/admin/task" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Task</span>
          </NavLink>
        </Menu.Item> 
        ...
        <Menu.Item key="5">
          <NavLink to="/admin/leave" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Leave request</span>
          </NavLink>
        </Menu.Item> 
        ...
        <Menu.Item key="6">
          <NavLink to="/admin/jobapply" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Job alert</span>
          </NavLink>
        </Menu.Item> 
      ...
      <span className="label" style={{fontSize:'17px'}}>Account</span>
        ...
        <Menu.Item key="8">
          <NavLink to="/admin/testimonial" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Testimonial</span>
          </NavLink>
        </Menu.Item>         
      <Menu.Item key="9">
          <NavLink to="/admin/reference" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Reference</span>
          </NavLink>
        </Menu.Item> 
        ...
        <Menu.Item key="10">
          <NavLink to="/admin/enquiry" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Enquiry</span>
          </NavLink>
        </Menu.Item> 
        ...
        <Menu.Item key="11">
          <NavLink to="/admin/admission" style={{textDecoration:"none"}}>
            ...
            <span className="label" style={{fontSize:'17px'}}>Admission</span>
          </NavLink>
        </Menu.Item> 
     </Menu>     
</div>
