...
//     const key = Date.now(); // Generate a unique key for each record
...
//             <Option value="IT">Teamlead</Option>
//             <Option value="HR">Staff</Option>
//             <Option value="Finance">Frontoffice</Option>
//           </Select>
//         </Form.Item>
...
//   const onFinish = (values) => {
//     const key = Date.now().toString(); // Convert timestamp to string for unique key
//     const newData = [...submittedData, { ...values, key }];
//     setSubmittedData(newData);
//     form.resetFields();
//   };
