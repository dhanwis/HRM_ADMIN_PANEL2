       ...
       <Row gutter={16}>
         ...
         <Col span={12}>
           ...
           >
             ...
             {/* <Form.Item label="Date of birth" name="dob" rules={[{ required: true, message: 'Please select join date' }]}> */}
           {/* <DatePicker style={{ width: "100%" }} /> */}
           {/* <DatePicker 
  style={{ width: "100%" }} 
  value={form.getFieldValue('dob') ? moment(form.getFieldValue('dob'), 'YYYY-MM-DD') : null} 
  onChange={(date, dateString) => form.setFieldsValue({ dob: dateString })} 
/> */}
...
{/* <Form.Item label="Join Date" name="joinDate" rules={[{ required: true, message: 'Please select join date' }]}> */}
           ...
           {/* <DatePicker 
  style={{ width: "100%" }} 
  value={form.getFieldValue('joinDate') ? moment(form.getFieldValue('joinDate')) : null} 
